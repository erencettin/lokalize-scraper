...
def _compute_stats(
    ...
    return {
        ...
        "total_events_before_dedup": tm_count + serpapi_count,
...
def main() -> int:
    ...
    print(f"Loaded tm_municipal={len(tm_events)} serpapi={len(serpapi_events)}")
    ...
    for serpapi_record in serpapi_events:
    ...
    stats = _compute_stats(merged, len(tm_events), len(serpapi_events), overlap_count)
