"""Custom parser for Avcılar Belediyesi."""
...
class AvcilarParser(SiteParser):
    """Parse Avcılar list pages and detail fields."""

    def parse_list(self, html: str, site: MunicipalSite) -> List[RawEventItem]:
        links = set()
        patterns = (
            r'href="(?P<link>https?://(?:www\.)?avcilar\.bel\.tr/etkinlik[^"#?]+)"',
